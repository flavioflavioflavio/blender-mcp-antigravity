...
optimize.register_tools(mcp, lambda: get_blender_connection())
render.register_tools(mcp, lambda: get_blender_connection())
bake.register_tools(mcp, lambda: get_blender_connection())
material_presets.register_tools(mcp, lambda: get_blender_connection())
gentex.register_tools(mcp, lambda: get_blender_connection())
